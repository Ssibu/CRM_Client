...
const PhotoGalaryForm = () => {
  ...
  // New state to hold initial data for reset
    ...
    const fetchPhoto = async () => {
      try {
        ...
        if (res.data.success && res.data.photo) {
          ...
          const existingUrl = isUploaded ? photo.photo_url : isLinked ? photo.photolink : "";
          ...
          setInitialData({ ...fetchedFormData, existingPhotoUrl: existingUrl, existingPhotoName: existingName });
