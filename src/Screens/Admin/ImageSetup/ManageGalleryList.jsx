...
//       },
//       { header: "Category (English)", accessor: "en_category", isSearchable: true, isSortable: true },
//       { header: "Category (Odia)", accessor: "od_category", isSearchable: true, isSortable: true },
...
//           icon={selectedItem.status ? FaTimes : FaCheck}
//           confirmText="Confirm"
//           cancelText="Cancel"
...
const ManageGallaryList = () => {
  ...
  // New state to handle image preview modal
        ...
        cell: ({ row }) => {
          ...
          return (
            <img
              src={imageUrl}
              alt="Thumbnail"
              className="h-12 w-24 rounded object-cover cursor-pointer hover:opacity-80"
              onClick={() => setPreviewImage(imageUrl)} // open image modal on click
            />
          );
        },
      },
