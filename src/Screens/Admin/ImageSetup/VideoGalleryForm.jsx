...
//             videoFile: `${import.meta.env.VITE_API_BASE_URL}/uploads/videos/${video.videofile}`,
//             videoLink: video.videotype === "link" ? video.videolink || "" : "",
//           };

//           console.log("videourl", fetchedData.videoFile)
...
//       if (id) {
//         setExistingVideoUrl(
//           initialData.videoSourceType === "upload" ? existingVideoUrl : ""
//         );
//       }
//     } else {
//       setFormData({
...
//       newErrors.en_title = "Title (EN) is required";
//     if (!formData.od_title.trim())
//       newErrors.od_title = "Title (OD) is required";
...
//       form.append(
//         "videotype",
//         formData.videoSourceType === "upload" ? "file" : "link"
//       );
//       if (formData.videoSourceType === "upload") {
//         if (formData.videoFile) {
...
//       if (id) {
//         res = await axios.put(
//           `${API_BASE_URL}/image-setup/update-video/${id}`,
//           form,
//           {
...
//           `${API_BASE_URL}/image-setup/register-video`,
//           form,
//           {
//             headers: { "Content-Type": "multipart/form-data" },
//             withCredentials: true,
...
//         showModal(
//           "success",
//           id ? "Video updated successfully!" : "Video registered successfully!"
//         );
//         navigate("/admin/image-setup/video-galary");
//       } else {
...
//             {existingVideoUrl && (
//             <div className="mb-6">
//              <video  src={formData.videoLink} ></video>
//             </div>
//           )}
