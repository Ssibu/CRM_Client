...
//   // Store the initial data for reset on edit (optional, but kept)
...
//   // Helper to build full URL for existing image
...
//         if (link.image_url) {
//           setExistingImageUrl(link.image_url);
//           setExistingImageName(link.image ? link.image.split("/").pop() : "");
//         } else {
//           setExistingImageUrl("");
...
//         // Save initial data for reset (optional, since reset clears everything)
//         initialDataRef.current = {
//           url: link.url || "",
//           existingImageUrl: link.image_url || "",
//           existingImageName: link.image ? link.image.split("/").pop() : "",
//           existingImageRemoved: false,
//         };
//       } catch (err) {
...
//   // Handle removing existing image or new image
...
//   // Reset form handler - **clears everything like your original reset**
//   const handleReset = () => {
//     setFormData({
//       url: "",
//       image: null,
...
//   // === Image preview logic ===
//   // If new file selected, create object URL for preview
//   // Else if existing image is not removed, show existingImageUrl
//   // Else no preview
...
//     } else if (!existingImageRemoved && existingImageUrl) {
//       setPreviewUrl(existingImageUrl);
//     } else {
//       setPreviewUrl(null);
//     }
//   }, [formData.image, existingImageRemoved, existingImageUrl]);
...
//                 existingFileUrl={previewUrl} // pass previewUrl here for preview
