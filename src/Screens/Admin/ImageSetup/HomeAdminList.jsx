    ...
    const fetchAdmins = async () => {
      try {
        const res = await axios.get(
          `${process.env.REACT_APP_API_URL}/admin/alladmins`,
          { withCredentials: true }
        );
        setAdmins(res.data.admins || []);  // assuming response shape { admins: [...] }
              ...
              <tr key={admin.id} className="border-t">
                ...
                <td className="px-4 py-2 border">
                  ...
                  {typeof admin.image === "string" && admin.image && (
                    <img
                      src={`${process.env.REACT_APP_API_URL}/uploads/${admin.image}`}
                      alt="Admin"
