            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className={`w-full border rounded px-3 py-2 h-40 ${fieldErrors.en_answer ? "border-red-500" : ""}`}
                  disabled={loading}
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className={`w-full border rounded px-3 py-2 h-40 font-odia ${fieldErrors.od_answer ? "border-red-500" : ""}`}
                  disabled={loading}
                />
