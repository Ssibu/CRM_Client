    ...
    try {
      ...
      if (response?.status === 400) {
        ...
        if (Array.isArray(errors) && errors.length > 0) {
          fullMessage = errors.map((err) => `• ${err}`).join("\n");
        } else {
          fullMessage = message || "Invalid input.";
        }
      } else {
        fullMessage =
  ...
  return (
    <div className="min-h-screen">
      <div className="bg-white p-6 shadow">
        <h1 className="text-lg font-semibold mb-6">Homepage Configuration</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              >
                <RichTextEditor
                  ...
                  onChange={(val) =>
                    handleInputChange("en_person_designation", val)
                  }
            ...
            <div>
              <label className="block text-sm font-medium mb-1">
                Overview Description (In English){" "}
                <span className="text-red-500">*</span>
              </label>
              <div
                className={`rounded-md border ${
              ...
              >
                <RichTextEditor
                  ...
                  onChange={(val) =>
                    handleInputChange("en_overview_description", val)
                  }
            ...
            <div>
              ...
              >
                <RichTextEditor
                  ...
                  onChange={(val) =>
                    handleInputChange("od_overview_description", val)
                  }
