...
if (isEditMode) {
  ...
  const fetchedData = {
    ...
    link: subMenu.link || "",
    image: null,
              metaTitle: subMenu.meta_title || "",
          metaKeyword: subMenu.meta_keyword || "",
          metaDescription: subMenu.meta_description || "",
  };
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("meta_keyword", formData.metaKeyword);
  ...
  return (
    ...
    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="mt-6">
              <label className="block text-sm font-medium mt-[10px] text-gray-700 mb-1">
                Meta Description
              </label>
              <textarea
