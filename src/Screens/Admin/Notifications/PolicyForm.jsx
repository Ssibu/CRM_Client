  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage =
        ...
        `Failed to ${isEditMode ? "update" : "create"} policy.`;
  ...
  return (
    <div className="min-h-[80vh]">
      <div className="bg-white p-6 shadow">
        <Header
          title={isEditMode ? "Edit Policy" : "Add Policy"}
          onGoBack={() => navigate("/admin/notifications/policy")}
        />
        <form onSubmit={handleSubmit}>
          <div className=" grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <DocumentUploader
              ...
              }/uploads/policies/${existingDocumentName}`}
