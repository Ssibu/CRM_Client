...
const NewsAndEventForm = () => {
 ...
 const handleReset = () => {
  ...
  return (
    <div className="h-[80vh] bg-gray-50 p-6" >
      ...
      <form onSubmit={handleSubmit}>
        <div className="bg-white p-6 rounded-lg shadow-md grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            <FormField label="Event Title (In English)"
            placeholder="English title here"
            value={formData.en_title} onChange={(val) => handleInputChange("en_title", val)} required error={errors.en_title}/>
            <FormField label="Event Title (In Odia)"            placeholder="Odia title here" value={formData.od_title} onChange={(val) => handleInputChange("od_title", val)} required error={errors.od_title}/>
