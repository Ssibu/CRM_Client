...
const Footerlink = () => {
  ...
  const columns = useMemo(() => [
    ...
    { header: "English Link", accessor: "en_link_text", isSearchable: true, isSortable: true },
    { header: "Odia Link", accessor: "od_link_text", isSearchable: true, isSortable: true },
    ...
    <div className="min-h-[80vh] py-4 font-sans">
      ...
      {modalState.isOpen && (
        <DeleteConfirmationModal
          ...
          message={`Change status of "${modalState.itemToToggle?.en_link_text}" to "${modalState.nextStatus}"?`}
          icon={VscVmActive}
