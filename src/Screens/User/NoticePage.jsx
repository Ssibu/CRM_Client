...
const NoticePage = () => {
    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            isSearchable: true,
            isSortable: true,
            cell: ({ row }) => translate(row.original, 'title'), 
        },
        {
        ...
        <div className="p-6 min-h-[80vh] font-sans">
            <div className="bg-white p-4 mb-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">{translate("from-date")}</label>
                        <Input
                            type="date"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">{translate("to-date")}</label>
                        <Input
                            type="date"
