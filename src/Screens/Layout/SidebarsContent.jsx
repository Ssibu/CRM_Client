  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        ...
        {
          label: "Sub-sub Menu",
          path: "/admin/menusetup/sub-submenu",
          icon: <RiArrowDropRightFill size={30} />,
        },
      ],
    },
    ...
    },
    {
      ...
      submenu: [
        ...
        {
          label: "Photo Gallery",
          path: "/admin/image-setup/phato-galary",
          icon: <RiArrowDropRightFill size={30} />,
        },
        {
          label: "Video Gallery",
        ...
        },
        {
          ...
          path: "/admin/image-setup/impotant-links",
          icon: <RiArrowDropRightFill size={30} />,
        },
      ],
    },
    {
      ...
      submenu: [
        {
          label: "Tender",
          path: "/admin/notifications/tender",
          icon: <RiArrowDropRightFill size={30} />,
        },
        {
          label: "Notice",
          path: "/admin/notifications/notice",
          icon: <RiArrowDropRightFill size={30} />,
        },
        {
          label: "Advertisement",
          path: "/admin/notifications/advertisement",
          icon: <RiArrowDropRightFill size={30} />,
        },
        {
          label: "Scheme",
        ...
        {
          label: "Holiday",
          path: "/admin/notifications/holiday",
          icon: <RiArrowDropRightFill size={30} />,
        },
      ],
    },
