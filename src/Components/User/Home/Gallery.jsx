...
const Galary = () => {
  ...
  const currentGalleryItems =
    galleryMode === "photo" ? data.photos : data.videos;
  ...
  return (
    <main className="w-full">
      ...
      >
        ...
        <div
          className="absolute left-0 top-0 h-full w-[28%] bg-[#4aa2ff66]"
          aria-hidden="true"
        ></div>
        <div
          className="absolute right-0 top-0 h-full w-[28%] bg-[#4aa2ff66]"
          aria-hidden="true"
        ></div>
  ...
  <div className="h-[240px] mt-4 bg-[#00000055] rounded-lg border border-white/20 overflow-hidden">
    {activeSocialLink ? (
      ...
      <p className="text-white text-center mt-20">No Social Link Available</p>
              ...
              <motion.section
                className="w-full md:w-[44%] bg-[#00000033] backdrop-blur-sm p-4 rounded-xl border border-white/30 shadow-md"
                custom={1}
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`${
                        galleryMode === "photo" ? "bg-[#ffc107]" : "bg-white"
                    ...
                    <button
                      ...
                      className={`${
                        galleryMode === "video" ? "bg-[#ffc107]" : "bg-white"
                      } text-sm px-2 py-1 rounded`}
                    >
                      {translate("Video")}
                    </button>
                ...
                <Swiper
                  ...
                  slidesPerView={2}
                  spaceBetween={12}
                  loop={currentGalleryItems.length > 2}
                  className="mt-4"
                >
                  {currentGalleryItems.map((item) => (
                    <SwiperSlide key={item.id}>
                      <a
                        href={item.photolink || item.videolink || "#"}
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <figure className="relative h-56 w-full overflow-hidden rounded-lg border border-white/20 group shadow-md">
                          {galleryMode === "photo" ? (
                            <img
                              src={`${API_URL}/uploads/photos/${item.photofile}`}
                ...
                <div className="mt-4 flex justify-end gap-2">
                  <motion.button
                    className="bg-[#ffc107] p-2 rounded-full"
                      ...
                      <motion.div
                        ...
                        className={`text-center py-1 rounded-md transition-all ${
                          ...
                          isToday
                            ...
                            : "border border-white/40 hover:bg-yellow-400 hover:text-black"
                        }`}
