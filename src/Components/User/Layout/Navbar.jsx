 ...
 if (item.link) {
  return (
    <a
      ...
      className={className}
      onClick={(e) => {
        if (!window.confirm(translate("open-new-tab"))) {
          e.preventDefault(); 
        }
      }}
    >
              ...
              {hasChildren && (
                <ul className="absolute left-1/2 transform -translate-x-1/2 top-full mt-0 w-56 bg-white text-black shadow-lg rounded-lg py-2 z-20 hidden group-hover:block">
                  {item.SubMenus.map((sub) => {
                    ...
                    return (
                      <li key={sub.id} className="relative submenu-item">
                        <LinkComponent
                          item={sub}
                          level={1}
                        ...
                        {hasSubChildren && (
                          <ul className="absolute left-full top-0 ml-1 w-56 bg-white text-black shadow-lg rounded-lg py-2 z-30 hidden submenu-item:hover subsubmenu">
