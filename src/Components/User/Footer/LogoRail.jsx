...
// const LogoRail = ({ logos = [] }) => { // Accept logos as a prop
//   return (
//     <div className="relative">
//       <div className="mx-auto -mt-14 w-[95%] md:w-[53%]">
//         <div className="rounded-b-[40px] bg-white/95 shadow-lg ring-1 ring-black/10 px-4 py-4">
//           <div className="flex flex-wrap justify-center gap-6">
//             {logos.map((logo, i) => ( // Map over the passed-in logos prop
//               <motion.div
//                 key={i}
//                 whileHover={{ scale: 1.08 }}
//                 whileFocus={{ scale: 1.08 }}
...
//                                 focus:ring-2 focus:ring-blue-600 focus:ring-offset-2">
//                   <img
//                     src={`${import.meta.env.VITE_API_BASE_URL}/uploads/important-links/${logo.src}`}
//                     alt={logo.alt}
//                     className="max-h-14 w-auto object-contain"
//                     loading="lazy"
//                   />
            ...
            {logos.map((logo, i) => {
              const LogoContent = (
                ...
                >
                  {/* Gradient Border */}
                  <div
                    className="absolute inset-0 rounded-xl bg-gradient-to-r from-[rgb(78,81,229)] 
                                via-[rgb(140,140,240)] to-[rgb(251,207,125,0.98)]
                                bg-[length:200%_200%] opacity-0 
                                group-hover:opacity-100 group-focus:opacity-100 
                                animate-gradient-spin pointer-events-none transition-opacity duration-300"
                  ></div>

                  {/* Inner white container */}
                  <div
                    className="relative z-10 flex h-full w-full items-center justify-center rounded-lg bg-white shadow-sm 
                                transition-all duration-300 ease-in-out 
                                hover:shadow-md 
                                focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
                  >
