...
import CategoryPhotos from "@/Screens/User/CategoryPhotos";
import CategoryVideos from "@/Screens/User/CategoryVideos";
import FooterLinkPage from "@/Screens/User/FooterLinkPage";
...
const nonAuthRoutes = [
  ...
  { path: "/subpage/photo-gallery", component: <PhotoGallery /> },
   { path: "/important-links", component: <FooterLinkPage category="ImportantLink" /> },
   { path: "/useful-links", component: <FooterLinkPage category="UsefulLink" /> },
  { path: "/subpage/photo-gallery/:id", component: <CategoryPhotos /> },
  { path: "/subpage/video-gallery", component: <VideoGallery /> },
  { path: "/subpage/video-gallery/:id", component: <CategoryVideos /> },
...
const adminRoutes = [
  ...
  { path: "/admin/user-management/log-records", component: <LogListPage /> },
];
